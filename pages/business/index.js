                    ...
                    <div className={styles.flex}>
                        ...
                        <form onSubmit={(e) => { handleSubmit(e, 'none') }}>
                            <div className='form-group'>
                                <input type="text" className="form-control" name="name" placeholder="Enter Name*" onChange={(e) => setOtpPhone(e.target.value)} required />
                            </div>
                            <div className='form-group'>
                                <input type="email" className="form-control" name="otp" placeholder="Enter Email ID*" onChange={(e) => setOtpPhone(e.target.value)} required />
                            </div>
                            <div className='form-group'>
                                <input type="text" className="form-control" name="number" placeholder="Enter Mobile Number*" onChange={(e) => setOtpPhone(e.target.value)} required />
                            </div>
                            ...
                            <div className='form-group'>
                                <input type="file" className="form-control" name="id" onChange={(e) => setOtpPhone(e.target.value)} required />
